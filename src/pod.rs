...
unsafe impl bytemuck::Pod for Point<Dip> {}
unsafe impl bytemuck::Zeroable for Point<Dip> {}
...
unsafe impl bytemuck::Pod for Size<Dip> {}
unsafe impl bytemuck::Zeroable for Size<Dip> {}
