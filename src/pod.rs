...
unsafe impl bytemuck::Pod for Point<Lp> {}
unsafe impl bytemuck::Zeroable for Point<Lp> {}
...
unsafe impl bytemuck::Pod for Size<Lp> {}
unsafe impl bytemuck::Zeroable for Size<Lp> {}
